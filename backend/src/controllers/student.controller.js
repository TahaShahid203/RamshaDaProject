...
const forgetPassword=asyncHandler(async(req,res)=>{
   ...
   <p>${resetToken}</p>
   <p>Thank you for being a valued member of the LearnBridge community. If you have any questions or need further assistance, please do not hesitate to contact our support team.</p>
   <p>Best regards,</p>
   <p>The LearnBridge Team</p>`
